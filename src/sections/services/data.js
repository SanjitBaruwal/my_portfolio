...
const data = [
  {
    ...
    icon: <SiAdobexd />,
    title: "UI/UX Design",
    desc: "My designs are modern and intutive. I us industry-standard rules to make sure your users have fun using your product",
  },
  {
    id: 2,
    icon: <RiReactjsLine />,
    title: "Frontend Development",
    desc: "Your product will look good and will be accessile on all devices, including mobile phones, tablets, and desktop.",
  },
  {
    id: 3,
    icon: <FaServer />,
